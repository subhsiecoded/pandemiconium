...
`;
const VirusIcon = () => (
  <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-virus" viewBox="0 0 16 16">
...
const Signup = ({ onSignup, darkMode }) => {
  ...
  const handleSignup = async (e) => {
    e.preventDefault();
    try {
      const response = await fetch("https://pandemiconiummanager.azurewebsites.net/SignUp", {
        method: "POST",
        headers: {
